/* Guards against t("…") keys that don't exist in messages/en/agents.json —
...
describe("agents i18n keys", () => {
  it("every static t() key used under app/agents exists in agents.json", () => {
