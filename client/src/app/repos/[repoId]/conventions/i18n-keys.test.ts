/* Guards against t("…") keys that don't exist in messages/en/conventions.json —
...
describe("conventions i18n keys", () => {
  it("every static t() key used under app/repos/[repoId]/conventions exists in conventions.json", () => {
